...
const PocketNetwork = React.forwardRef<
  SVGSVGElement,
  {
...
>(({iconRef, ...props}, ref) => {
  return (
    <SvgIcon viewBox="0 0 299.99 300.01" {...props} ref={iconRef || ref}>
      <path
        fill="#1D8AED"
        d="M193.62,6.47v55.98c0,18.14-14.71,32.84-32.85,32.83h-0.48l0,0c-9.11-0.06-17.28,0-17.28,0

...
>(({iconRef, ...props}, ref) => {
  return (
    <SvgIcon viewBox="0 0 469 527" {...props} ref={iconRef || ref}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        fill="#060606"
        d="M0,389.9c6.4,3.4,14.8,8.6,20.8,12.6c2.2,1.5,4.7,2.8,7.1,4.3c1.3,0.8,2.1,1.2,3.3,2c0.6,0.4,1.1,0.8,1.7,1.1
	...
	c-1.6-0.9-2.8-1.6-4.4-2.6L4.6,139.4c-1.7-0.9-3-1.9-4.6-2.7L0,389.9L0,389.9z"
      ...
      <path
        ...
        clipRule="evenodd"
        fill="#060606"
        d="M245.5,265.5v100.3l13.3-7.5c6.1-3.2,11.7-7.1,17.8-10.3c1.1-0.6,1.5-0.8,2.3-1.4c0.8-0.5,1.6-0.8,2.4-1.2
	...
	l-7.1,3.9c-4.2,2.2-7.9,4.9-12.1,7.1c-1,0.5-1,0.7-1.8,1.1l-7.1,3.9C261.7,256,249.3,264.7,245.5,265.5L245.5,265.5z"
      ...
      <path
        ...
        clipRule="evenodd"
        fill="#060606"
        d="M13.9,119.9c1.4,0.3,2.2,1.1,3.5,1.8c4.7,2.5,8.9,5.5,13.7,7.9l38,22c18.1,11,36.9,20.8,55.1,31.8l3.4,1.9

...
>(({iconRef, ...props}, ref) => {
  return (
    <SvgIcon viewBox="0 0 124.1 124.1" {...props} ref={iconRef || ref}>
      <circle fill="#F2E3EE" cx="62" cy="62" r="60" />
      <circle fill="#D9327C" cx="62" cy="62" r="62" />
      <path
        fill="#FFFFFF"
        fillRule="evenodd"
        clipRule="evenodd"
        d="M59.6,32.7c-0.5,0.4-1.1,1.1-1.5,2.4c-0.4,1.3-2.6,7.7-5.4,15.7h18.7c-2.8-8-5-14.4-5.4-15.7
